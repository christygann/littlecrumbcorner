...
// Flip to true when the next home cafe is live
const CAFE_ACTIVE = false

export default function HomeCafe() {
  return (
    <section id="home-cafe" className="relative px-5 py-14 sm:px-8 sm:py-20 lg:px-16 lg:py-[110px]">
      <SectionHeader eyebrow="home cafe" title={CAFE_ACTIVE ? 'come to our next home cafe' : 'home cafe'} />
      ...
      {CAFE_ACTIVE ? (
        ...
        <div className="text-center max-w-sm mx-auto">
          <p className="font-display font-light text-[32px] sm:text-[40px] text-espresso mb-4 leading-[1.15]">
            stay tuned for the next one
          </p>
          <p className="text-[14px] text-cocoa/60 leading-relaxed">
            follow us on instagram or telegram to be the first to know.
          </p>
        </div>
      )}
    </section>
